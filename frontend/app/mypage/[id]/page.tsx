...
const Mypage = ({params}:any) => {
  ...
  useEffect(() => {
    const fetchAverageData = async () => {
      try {
        const response = await axios.get('https://shintaro.pythonanywhere.com/average_data', { params: { user_id: params.id }});
  ...
  const handleSaveData = async () => {
    try {
      await axios.post('https://shintaro.pythonanywhere.com/save_data', { weight: weight, sleep_hours: sleepHours, user_id: params.id });
  ...
  const handleVisualize = async () => {
    try {
      const response = await axios.get('https://shintaro.pythonanywhere.com/visualize', {params: { user_id: params.id }});
  ...
  const handleLogout = async () => {
    try {
        await axios.get('https://shintaro.pythonanywhere.com/logout');
